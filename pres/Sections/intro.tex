...
\begin{figure}
\centering
\hspace*{1em}\vspace*{-0.5em}\begin{tikzpicture}
...
\hspace*{-3.2em}\begin{column}{0.5\textwidth}
	\includegraphics[width=1.28\columnwidth]{biasvar-rf-apple}
\end{column}
\hspace*{-1.5em}\begin{column}{0.5\textwidth}
	\includegraphics[width=1.28\columnwidth]{vip-rf-apple}
\end{column}
\end{columns}
...
\hspace*{-4em}\begin{column}{0.5\textwidth}
	\includegraphics[width=1.28\columnwidth]{vip-ada1-apple}
\end{column}
\hspace*{-1em}\begin{column}{0.5\textwidth}
	\includegraphics[width=1.28\columnwidth]{vip-ada2-apple}
\end{column}
\end{columns}
