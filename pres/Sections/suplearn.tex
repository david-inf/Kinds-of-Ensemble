...
\begin{frame}{Super Learner library CV error}

\begin{columns}[T]
\hspace*{-3.7em}\begin{column}{0.5\textwidth}
	\begin{tikzpicture}
		%	\draw[help lines] (0,0) grid (6,6); \node[draw,circle,fill=red] at (0,0) {};
		\node[immagine] at (0,0) {\includegraphics[width=1.28\columnwidth]{../r-StatsLearn-Exam/src/plots/SL-final-coef}};
...
\hspace*{-0.5em}%
\begin{column}{0.5\textwidth}
	\includegraphics[width=1.28\columnwidth]{SL-final-cv}
\end{column}
\end{columns}
