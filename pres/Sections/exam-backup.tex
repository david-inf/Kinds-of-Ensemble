...
\begin{column}{0.3\textwidth}
	\includegraphics[width=1.5\columnwidth]{vip-rf-apple}
\end{column}
\hspace*{-0.4em}%
\begin{column}{0.3\textwidth}
	\includegraphics[width=1.5\columnwidth]{vip-ada1-apple}
\end{column}
\hspace*{-0.4em}%
\begin{column}{0.3\textwidth}
	\includegraphics[width=1.5\columnwidth]{vip-ada2-apple}
\end{column}
\end{columns}
